    ...
    <div className="bg-white p-6 rounded-xl shadow-lg">
      <form onSubmit={handleSubmit(onSubmit)} noValidate>
        ...
        <div className="md:col-span-2 pt-6 border-t mt-6">
          <h3 className="text-lg font-medium text-gray-800 mb-4">Your Preferences</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            
            <div>
              <label htmlFor="boards" className="block text-sm font-medium text-gray-700 mb-1">
            ...
            <div>
              <label htmlFor="preferredStandard" className="block text-sm font-medium text-gray-700 mb-1">
            ...
            <div className="md:col-span-2">
              ...
              <select id="interests" {...register("interests")} className="w-full p-2 border border-gray-300 rounded-md">
                ...
                <option value="Focusing on Academics">Focusing on Academics</option>
                <option value="Focuses on Practical Learning">Focuses on Practical Learning</option>
                <option value="Empowering in Sports">Empowering in Sports</option>
