...
Documents to Bring:
${formData.documentsToBring || 'Please bring all original documents mentioned in your application.'}

${formData.additionalNotes ? `Additional Notes: ${formData.additionalNotes}` : ''}
      `.trim();

      await onSchedule(application.formId, 'Interview', interviewNote);
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <input
              ...
              onChange={handleInputChange}
              required
              placeholder="e.g., Admin Office, 2nd Floor, Main Building"
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={handleInputChange}
                placeholder="e.g., Mrs. Smith, Admission Officer"
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              />
            </div>
            <div>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleInputChange}
              rows={3}
              placeholder="e.g., Please arrive 15 minutes early. Bring a parent/guardian. Dress code: Formal attire."
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleInputChange}
              rows={3}
              placeholder="e.g., Birth certificate, Report card, Aadhar cards of parents, Passport size photos, etc."
              className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            />
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            <h4 className="font-medium text-gray-900 mb-2">Interview Details Preview:</h4>
