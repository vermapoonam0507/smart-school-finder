  ...
  <div className="bg-gray-50">
    <section className="text-center py-20 md:py-32 bg-white">
      <div className="container mx-auto px-6">
        ...
        <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8">
          Discover, compare, and apply to the best schools for your educational journey.
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link to="/schools" className="bg-blue-600 text-white font-semibold px-8 py-3 rounded-lg hover:bg-blue-700 shadow-lg w-full sm:w-auto">
            Browse Schools
          </Link>
          <Link to="/signup-school" className="bg-white text-gray-700 font-semibold px-8 py-3 rounded-lg hover:bg-gray-100 border border-gray-300 shadow-lg w-full sm:w-auto">
    ...
    <section className="bg-gray-800 text-white">
      <div className="container mx-auto px-6 py-16 text-center">
        ...
        <Link to="/schools" className="bg-blue-600 text-white font-semibold px-8 py-3 rounded-lg hover:bg-blue-700 shadow-lg">
          Explore Schools Now
        </Link>
      </div>
    </section>
