    ...
    useEffect(() => {
        ...
        const handleVerification = async () => {
            try {
                ...
                // 3 second baad user ko login page par bhej denge
                setTimeout(() => {
                    navigate('/login');
                }, 3000);
            ...
            case 'success':
                return (
                    <>
                        ...
                        <p className="text-gray-600 mt-2">Your account has been successfully verified. Redirecting you to the login page...</p>
                    </>
                );
            case 'error':
                return (
                    <>
                        ...
                        <p className="text-gray-600 mt-2">The verification link is invalid or has expired. Please try signing up again.</p>
                        <Link to="/signup" className="mt-4 text-blue-600 hover:underline">Go to Sign Up</Link>
                    </>
                );
            default: // 'verifying'
                return (
